...
```
  ...
  console.log("My name is " + name + ", and my birthday is in the month of " + monthNames[monthNumber+1] + ".");
 ```
...
```
  My name is L, and my birthday is in the month of September.
```
...
```
  ...
  console.log(`My name is ${name}, and my birthday is in month of ${monthNames[monthNumber-1]}.`);
```
...
```
  let data = [
   ...
   console.log("My name is " + data[0] + " " + data[1] + ", and my email address is " + data[2] + ".");
   console.log();
   console.log(dtaa[data.length-1]);
```
...
```
  ...
  console.log(`My name is ${data.firstName} ${data["last-name"]}, and my email address is  
  ${data["email_address"]},\n\n${data.email_address}`);
```
...
```
  if (count === 0) {
    console.error("This program requires that you provide numeric arguments.")
    process.exit(1);
  }
```
**Grading (15pts)**
